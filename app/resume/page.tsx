        ...
        <section className={`${styles.col} ${styles.left}`}>
          ...
          <div className={styles.item}>
            ...
            <ul>
              ...
              <li>
                Designed and ran A/B test inverting the onboarding funnel,
                letting users create an invoice before signup, doubling signup
          ...
          <div className={styles.item}>
            ...
            <ul>
              ...
              <li>
                Won internal and external hackathons for PayPal, recruited,
                helped plan PayPal’s annual developer conference.
              </li>
              <li>
          ...
          <div className={styles.item}>
            ...
            <ul>
              ...
              <li>
                Wrote binary search typographic headline balancer that ran on
                all nytimes.com article pages.
              </li>
            </ul>
          </div>
          <div className={styles.item}>
            ...
            <ul>
              <li>
                Worked among several departments to prioritize, design, and
                build web applications to support UCLAʼs largest athletic
                events.
              </li>
              <li>
